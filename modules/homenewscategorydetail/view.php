    ...
    foreach ($cateinhome as $cat) {
        ...
        <div class="center-main-center">
            <div class="title-main">
                <h3><a style="color: #fff;text-transform: uppercase;font-family: Arial, Helvetica, sans-serif;font-size: 14px;font-weight: bold;display: block"
                       href="<?php echo $cat['link']; ?>"> <?php echo $cat['cat_name']; ?></a></h3>
                <!--
                    ...
                    <?php if ($first) { ?>
                        <div class="news-hot-title">
                            <a href="<?php echo $first['link']; ?>">
                                <img alt="<?php echo $first['news_title']; ?>"
                                     src="<?php echo ClaHost::getImageHost() . $first['image_path'] . 's400_400/' . $first['image_name']; ?>"
                                     alt="<?php echo $first['news_title']; ?>"/>
